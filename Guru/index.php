  ...
  <body >
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            <div  class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <li class="nav-item active">
                    <a class="nav-link shadow bg-body rounded daftar " style="background-color : rgb(151, 151, 151);" href="index.php">Jurusan <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link " href="../pendaftaran/index.php">Pendaftaran <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link " href="../pembayaran/index.php">Pembayaran <span class="sr-only">(current)</span></a>
                </li>
                </ul>
            </div>
            </nav> -->
        ...
        <center>
            ...
            <h2 class="h2 mt-auto"  style='font-weight: bolder'>Data Guru</h2>
            <span class="d-block w-50 bg-dark" style='height: 3px'></span>
            <br><br>
        </center>
        <!-- CARDs -->
        <div style="width: 95% mx-auto my-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="edit.php?NO=<?php echo $data['NO']; ?>" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
